...
import FooterSection2 from './FooterSections/FooterSection2';
import FooterSection1 from './FooterSections/FooterSection1';
            ...
            <>
                ...
                <div className="footer3">
                    <div className="wrapper">
                        <div className="row max-width d-flex flex-wrap align-items-center">
                                ...
                                <button className="btn btn-footer">
                                    <span>
                                        <svg width="20" height="20" viewBox="0 0 20 20" aria-hidden="true" focusable="false">
                                            <title>US</title>
                                            <defs>
                                                <path d="M9.68 20.004C4.3 19.834-.02 15.392 0 9.972.02 4.466 4.5.002 10 .002h.035C15.55.022 20.02 4.522 20 10.04c-.016 5.398-4.328 9.795-9.68 9.964h-.64z" id="a"></path>
                                                <path d="M9.68 20.004C4.3 19.834-.02 15.392 0 9.972.02 4.466 4.5.002 10 .002h.035C15.55.022 20.02 4.522 20 10.04c-.016 5.398-4.328 9.795-9.68 9.964h-.64z" id="d"></path>
                            ...
                            <div className="col text-right text-white">
                                <span className="d-inline-block copyright"> © 2020 Etsy, Inc. </span>
                                <ul className="list-inline d-inline-block">
                                    <li className="list-inline-item"><a href="#">Terms of Use</a></li>
                                    <li className="list-inline-item"><a href="#">Privacy</a></li>
                                    <li className="list-inline-item"><a href="#">Interest-based ads</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
